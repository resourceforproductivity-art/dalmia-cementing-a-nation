...
export function Header() {
  ...
  return <>
    ...
    <dialog ref={dialog} id="main-menu" className="menu-dialog" aria-label="Explore Dalmia Bharat" onClose={() => { setOpen(false); toggle.current?.focus({ preventScroll: true }); }}>
      <div className="menu-top"><Image src={assetPath("/images/dalmia-logo.png")} alt="Dalmia Bharat" width={200} height={117} /><button className="close-button" aria-label="Close menu" onClick={close}><span>CLOSE</span><span className="close-mark" /></button></div>
